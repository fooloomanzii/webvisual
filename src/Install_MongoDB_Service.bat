...
mongod -config %temp%\mongodb.conf --install --serviceName %name% --serviceDisplayName "MongoDB Server Instance %port%" --serviceDescription "MongoDB Server Instance running on %port%" --nojournal -rest
